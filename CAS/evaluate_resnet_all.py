...
real_model_accuracy = []
fake_model_accuracy = []
for meta_num in range(len(meta_list_string)):
    ...
    real_model_accuracy.append(best_validation_accuracy_real)
    print(f"best_validation_accuracy_fake for real data is {best_validation_accuracy_fake}")
    fake_model_accuracy.append(best_validation_accuracy_fake)
print("--------------------------finished!!--------------------------------")
difference_sum = 0
for i,name in enumerate(meta_list_string):
    print(f"-----comparing accuracy for {meta_list_string[i]}------")
    print(f"real_model_accuracy : {real_model_accuracy[i]}")
    print(f"fake_model_accuracy : {fake_model_accuracy[i]}")
    difference_sum += (real_model_accuracy[i]-fake_model_accuracy[i])/real_model_accuracy[i]
print("--------------------------overall score for this model!!--------------------------------")
print(difference_sum/11)
